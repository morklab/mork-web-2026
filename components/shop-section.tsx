...
export function ShopSection() {
  const [filter, setFilter] = useState<"all" | "merch" | "tickets">("all")
  ...
  useEffect(() => {
    ...
    const handleClick = () => setTimeout(checkHash, 100)
  ...
  const handleManualFilter = (newFilter: "all" | "merch" | "tickets") => {
    setFilter(newFilter)
